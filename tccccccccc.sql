...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28/11/2025 às 00:21
...
(1, 'SP', 'Caçapava', 'JD.Primavera', 'General Pedro Luís Pedro Bitencourt', 255, 'casa');
...
(1, '88888888888', 'Admin', 'admin@123', 'admin', 2, '2008-08-08', '88888888888', 1);
...
CREATE TABLE `pedido` (
  ...
  `statusPedido` varchar(250) NOT NULL,
